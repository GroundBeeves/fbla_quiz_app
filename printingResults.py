...
filename = 'fbla_quiz_results.pdf'
...
def runPrinting(question_list, user_answer_list, correct_answer_list, correct_status_list, directory):
    ...
    for question, user_ans, corr_ans, corr in zip(question_list, user_answer_list, correct_answer_list, correct_status_list):
        pdf.setFillColorRGB(0, 0, 0)
        pdf.drawString(margin, height, "Question " + str(qnumber) + ": " + question)
